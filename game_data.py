...
ITEMS = {
    ...
    "ascia_boscaiolo":       {"name": "Ascia da Boscaiolo",             "slot": "arma", "rarity": "base",        "effects": {"dmg": 1, "penetrazione_armor": 1}, "lore": "Più adatta a spaccare legna che carne, ma nelle mani giuste fa comunque il suo."},
    ...
    "martello_compagni":     {"name": "Martello dei Compagni",         "slot": "arma", "rarity": "base",        "effects": {"dmg": 1, "stordisce_pct": 0.10},"lore": "Forgiato nelle fucine di Karag-Duraz, porta il sigillo dei Compagni del Martello."},
    ...
    "plumbus":               {"name": "Un Plumbus",                    "slot": "armatura", "rarity": "base",    "effects": {"xp_bonus_pct": 0.20},           "lore": "Tutti hanno un plumbus a casa. Prima prendono il dinglebop e lo lisciano con un po' di schleem. Lo schleem viene poi riutilizzato per i lotti successivi. Prendono il dinglebop e lo spingono attraverso il grumbo, dove il fleeb viene strofinato contro di esso. È importante che il fleeb venga strofinato, perché il fleeb contiene tutto il succo di fleeb. Poi arriva uno schlami, lo strofina e ci sputa sopra. Tagliano il fleeb. Ci sono diversi hizzards sul percorso. I blamfs si strofinano contro i chumbles. E i ploobis e il grumbo vengono rasati via. Questo ti lascia con un caro vecchio plumbus."},
    "lama_giuramento":       {"name": "Lama del Giuramento Spezzato",   "slot": "arma", "rarity": "epica",       "effects": {"dmg": 2, "penetrazione_armor": 1}, "lore": "Si dice fosse impugnata da un Arconte caduto, spergiuro alla propria stessa causa."},
    ...
    "spadone_gowain":        {"name": "Spadone Lungo di Ser Gowain",   "slot": "arma", "rarity": "epica",       "effects": {"dmg": 2, "shield_pv_su_colpo_chance": 0.20, "shield_pv_su_colpo_amount": 3}, "lore": "Portato da un cavaliere errante che non giurò mai fedeltà a nessun signore — solo alla propria parola."},
    "spezzacielo":           {"name": "Spezzacielo",                    "slot": "arma", "rarity": "leggendaria", "effects": {"dmg": 3, "critico_colpisce_timore": True}, "lore": "Il colpo finale di un condottiero mai nominato nelle cronache ufficiali, per volere di chi vinse quella guerra."},
    # ARMATURE FISICHE
    ...
    "armatura_sigillo":      {"name": "Armatura del Sigillo Infranto",  "slot": "armatura", "rarity": "epica",       "effects": {"armor": 2, "riflette_chance": 0.20, "riflette_fisso": 1}, "lore": "Un tempo proteggeva un tempio ormai crollato; protegge ancora, a modo suo."},
    "elmo_karag_duraz":      {"name": "Elmo del Primo Re di Karag-Duraz", "slot": "armatura", "rarity": "epica",     "effects": {"armor": 2, "immunita_sanguinamento": True}, "lore": "Forgiato per il sovrano che unificò le fucine naniche; nessuna lama nemica trovò mai la sua vena."},
    "egida_bastione":        {"name": "Egida dell'Ultimo Bastione",     "slot": "armatura", "rarity": "leggendaria", "effects": {"armor": 3, "bonus_armor_sotto_quarto": 2}, "lore": "Indossata da chi non ha mai indietreggiato — e non è mai tornato a raccontarlo."},
...
RADDOPPIO_SOTTO_QUARTO_SOGLIA = 0.25  # Egida dell'Ultimo Bastione: soglia di Vita sotto cui scatta il bonus fisso all'Armatura (una sola volta a combattimento)
